...
class iFilters{
     ...
     */
    public function variable(mixed $value, int $filter = FILTER_DEFAULT, array|int $options = 0): mixed{
     ...
     */
    public function input_url($var):mixed{
     ...
     */
    public function input_int($var):mixed{
     ...
     */
    public function input_ip($var):mixed{
     ...
     * @return mixed (string|false|null)
     */
    public function input_domain($var):mixed{
     ...
     * @return mixed (string|false|null)
     */
    public function input_InterPhone($var,$reg="^\+(?:[0-9\-] ?){6,14}[0-9]$"):mixed{
     ...
     * @return mixed (string|false|null)
     */
    public function input_localPhone($var,$reg="^([0-9]){0,12}$"):mixed{
        $tel = filter_input(INPUT_POST, $var, FILTER_VALIDATE_REGEXP, [
            'options' => [
                'regexp' => '/'.$reg.'/'
            ]
     ...
     * @return mixed (string|false|null)
     */
    public function input_regex(string $var, string $reg):mixed{

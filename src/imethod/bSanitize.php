...
class bSanitize{
     ...
     * @return mixed
     */
    public function encoded(mixed $var):mixed{
     ...
     * @return mixed
     */
    public function Integer(mixed $var):mixed{
     ...
     * @return mixed
     */
    public function float(mixed $var):mixed{
     ...
     * @return false|string
     */
    public function url(mixed $var):mixed{
     ...
     * @return mixed
     */
    public function email(mixed $var):mixed{
     ...
     * @return string
     */
    public function text(string $var){

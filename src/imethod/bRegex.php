...
class bRegex{
     ...
     */
    public function grep(string $pattern, array $array, int $flags = 0): array|false{
     ...
     */
    public function filter(string|array $pattern, string|array $replacement, string|array $subject, int $limit = -1, int &$count = null): string|array|null{

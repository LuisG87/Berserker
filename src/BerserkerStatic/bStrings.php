...
/**
*  Berserker
* Classes for PHP Language string functions
*/
...
class bStrings{
    ...
    */
     ...
     * @return void
     */
    public static function render(string ...$expressions): void{
        foreach ($expressions as $expression) {
            echo $expression; 
        }
    }
     ...
     */
    public static function naturalOCompare(string $str1, string $str2): int{

...
class bArrays{
     ...
     * @return int - array length
     */
    public static function append(array &$array, mixed ...$values): int{
        return array_push($array, ...$values);
    }
     ...
     */
    public static function removeLast(array &$array): mixed{
        return array_pop($array);
    }
     ...
     * @return mixed - the removed value or null if is empty or not an array
     */
    public static function removeFirst(array &$array): mixed{
        return array_shift($array);
    }
     ...
     * @return int -length of the array
     */
    public static function prepend(array &$array, mixed ...$values): int{
        return array_unshift($array, ...$values);
    }
     ...
     * @return int
     */
    public static function length(Countable|array $value, int $mode = COUNT_NORMAL): int{
     ...
     * @return int|float
     */
    public static function sumValues(array $array): int|float{
     ...
     * @return array
     */
    public static function makeFrom(array|string $var_name, array|string ...$var_names): array{
     ...
     * @return array
     */
    public static function portion(array $array, int $offset, ?int $length = null, bool $preserve_keys = false): array{
        return array_slice($array, $offset, $length, $preserve_keys);
    }
}
